...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ZeligStylerSDK",
            url: "https://storage.googleapis.com/ios-widget-sdk-zelig-dev/ZeligStylerSDK-2.0.0.xcframework.zip",
            checksum: "c5f3ac198785dc6c07780a3a07f8cd30636cff0e864dcea6f6ec3bb687b14896"
        )
    ]
)
