...
Pod::Spec.new do |spec|
  ...
  spec.source = {
    :http => "https://storage.googleapis.com/ios-widget-sdk-zelig-prod/ZeligStylerSDK-2.0.1.xcframework.zip",
    :type => :zip,
    :sha256 => "09244d9d7b410de61a0fba138bc39b525f5e28f1e6ff08700aee995ee22ed6c9"
  }
